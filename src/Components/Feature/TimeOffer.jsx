  ...
  return (
    <div className='bg-cardLi py-[20px] font-primary'>
        <div className="md:container flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a className='text-heading flex items-center justify-between gap-3 hover:text-primary transition-all duration-300 ' href="https://www.facebook.com/profile.php?id=100067178573868" target='_blank'>Purchase Now <FontAwesomeIcon className='mt-1 link-animation' icon={faArrowRight} /></a>
        </div>
    </div>
  )
}
